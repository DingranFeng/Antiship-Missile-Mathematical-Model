...
dC=9.5e3;   %%%%%%%%%%%%%末段飞行距离(以美国AN/TPS-79防空雷达作用距离为例)
...
for theta=linspace(0.6332,1.3744,n) %选取第1问结果中命中率较高的发射角范围
    ...
    plot(1:tC,acos(vh(1:tC)./v(1:tC)));
end
ylabel('俯仰角(rad)');xlabel('时间(t)');
title('俯仰角-时间');
grid on
hold off