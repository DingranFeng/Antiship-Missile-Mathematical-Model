...
dC=9e3;   %%%%%%%%%%%%%末段飞行距离(以美国AN/TPS-79防空雷达作用距离为例)
...
for theta=linspace(0.6332,1.3744,n) %选取第1问结果中命中率较高的发射角范围
    ...
    plot3(Pm(1,1:tC),Pm(2,1:tC),Pm(3,1:tC));
end
plot3(Pa(1,1:tC),Pa(2,1:tC),Pa(3,1:tC),'linewidth',3);
xlabel('X(m)');ylabel('Y(m)');zlabel('Z(m)');
title('w=0.34时不同发射角的弹道');
axis([0 2.7e5 0 3.8e5 0 4e4]);
legend('其他曲线:导弹轨迹','航母轨迹');
box on
grid on
hold off
%%%%%%%%%%%%%%%%%%%%%%
